...
public class Salida {
    ...
    //--------------------------------------------- Crear Salida ---------------------------------------------------
    public void salidaEmpleado(Label labInformacion, TextField textCodigo) throws ParseException {
        ...
        try {
            ...
            while (rs.next()){
                ...
                String consulta2 = "INSERT INTO salida(hora, fecha, idEmpleadoFK) VALUES (?, ?, ?)";
